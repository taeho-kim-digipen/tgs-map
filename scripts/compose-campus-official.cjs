...
firstFloor.push(fullOverlay('main', mainSource, mainTarget));

const halls911 = reg.panels.find(p => p.map === 'halls911');
if (halls911) firstFloor.push(fullOverlay('halls911', halls911.from, rect(panelTransforms[halls911.id], halls911.from)));
